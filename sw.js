...
    self.skipWaiting();
  }
}); - modify my code to implement code after this // Add this inside your index.html script where you register the SW
...
          // This only fires if there is an existing version and a new one just finished installing
          showToast("New Update Available! Please refresh.", "success");
          // You could show a special "Refresh Now" button here
        }
      });
    });
  });
